...
```{r Table, fig.align = 'left', out.width = "100%", out.height = "100%", fig.cap = "Table 2. Summary of characteristics for four intertidal snails.", fig.cap.align = 'left', echo=FALSE}
knitr::include_graphics(here::here("images", "Summary Table.jpg"))
```
